# Week 3 - Event-Driven Programming and Interrupts
...
### 3.1.4 Interrupt Source Examples
...
* `handle_arm_press`,  `handle_disarm_press`, `handle_setcode_press`, `handle_code0_press`, and  `handle_code1_press` all ISRs which handle their respective button press events. They ensure proper debouncing, update program state, and set logging flags for the main loop.
